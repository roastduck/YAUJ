...
build/yauj_judger : build/decl_part build/init_part build/run_part src/main.cpp src/interpreter.cpp src/function.cpp src/interpreter.h src/function.h src/config.h
	g++ src/interpreter.cpp src/function.cpp src/main.cpp -o build/yauj_judger -std=c++11 -lsandbox -ljsoncpp -Isrc -Ibuild -g -Wall
